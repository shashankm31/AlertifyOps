...
from app.integrations.azure_monitor import normalize_azure_alert
...
def azure_webhook(
    ...
    #1. Normalize Azure alert
    normalized_alert = normalize_azure_alert(payload)
